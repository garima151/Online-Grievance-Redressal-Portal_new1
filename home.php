...
<body>
      ...
      <div class="container-fluid ">
         <div class="row">
            <div class="col-sm-2 col-6">
               <!-- <a class="logo" href="index.php"><h1 style="font-size: 40px;color: white;">Speak Up, We Listen!</h1></a> -->
            </div>
            <div class="col-sm-8 col-6">
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                     <ul class="navbar-nav">
                        <li class="nav-item">
                           <a class="nav-link" href="refresh.php">Home</a>
                        </li>
                        <li class="nav-item">
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                     <h1 class="banner_taital">Complain & Conquer: Together We Improve!</h1>
                     <div class="read_bt"></div>
                     <div class="number_main">
   ...
   <div class="copyright_section">
      <div class="container">
         <p class="copyright_text">Made by Garima Samaddar
            </p>
      </div>
   </div>
